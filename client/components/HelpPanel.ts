    ...
    h('div', {
      ...
      Section('Tips',
        h('div', { style: 'font-size: 12px; color: var(--gruvbox-gray); line-height: 1.7;' },
          ...
          h('p', { style: 'margin: 0 0 6px;' },
            h('strong', { style: 'color: var(--gruvbox-fg);' }, 'Focus mode: '),
            'Click the focus button in the Docs tab to hide the file tree and TOC for distraction-free reading.',
          ),
          h('p', { style: 'margin: 0 0 6px;' },
            h('strong', { style: 'color: var(--gruvbox-fg);' }, 'Command palette: '),
            h('code', { style: 'font-size: 11px; color: var(--accent, var(--gruvbox-yellow));' }, `${mod}K`),
            ' searches across all docs, pages, and quick actions.',
          ),
          h('p', { style: 'margin: 0;' },
            h('strong', { style: 'color: var(--gruvbox-fg);' }, 'Theme: '),
